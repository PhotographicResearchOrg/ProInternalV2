...
import { KanbanCard, Comment, ListName, Task } from 'src/app/prointernalengine/api/kanban';
import { Member } from 'src/app/prointernalengine/api/member';
import { KanbanAppComponent } from '../kanban.app.component';
import { MemberService } from 'src/app/prointernalengine/service/member.service';
